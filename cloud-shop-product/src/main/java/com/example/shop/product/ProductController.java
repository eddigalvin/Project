...
public class ProductController {
	...
	public @ResponseBody Iterable<Product> getAllProduct() {
		...
		//Controller action uses Thymeleaf View Template Engine														
				...
				public ModelAndView getProduct(@RequestParam int id) {
					ModelAndView mvw1 = new ModelAndView();
					mvw1.setViewName("product"); 
					Product prod=  (Product)productRepository.findOne((Integer)id);
					  mvw1.addObject("prod",prod);
					  return mvw1;
				}							
	...
	*/
	...
	public @ResponseBody Product getProd(@RequestParam int id){
		
		return productRepository.findOne(/*(Integer)id*/id);
	}
