...
public class OrderlineController {
	...
	public @ResponseBody ArrayList<OrderLine> addNewOrderLine (
		...
		Product prod = restTemplate.getForObject("http://localhost:8080/product/one?id="+productId,Product.class);
		//Product prod = restTemplate.getForObject("https://lit-inlet-86489.herokuapp.com/product/one?id="+productId,Product.class);
	...
	public @ResponseBody Order/*String*/ createOrder(@RequestParam int custId) {
		...
		//Order o = restTemplate.postForObject("https://dry-sands-42378.herokuapp.com/order/add/?custId="+custId,custCart,Order.class);
